...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : lcd_RW_Pin lcd_RS_Pin lcd_EN_Pin */
  GPIO_InitStruct.Pin = lcd_RW_Pin|lcd_RS_Pin|lcd_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : START_TIMER_Pin STOP_TIMER_Pin */
  GPIO_InitStruct.Pin = START_TIMER_Pin|STOP_TIMER_Pin;
